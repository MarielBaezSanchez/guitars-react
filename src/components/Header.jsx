...
export default function  Header({ carrito, agregarCarrito, quitaUno, vaciarCarrito, quitaGuitarra, guitar }) {
    //sudghu
    const total = useMemo(() => carrito.reduce((total, guitar) => total + guitar.cantidad * guitar.precio, 0), [carrito])
    return (
        ...
        <div className="container-xl">
                                ...
                                <tbody>
                                                        {
                                                            carrito.map((guitarra) => (
                                                                <tr key={guitarra.id}>
                                                                    ...
                                                                    <td className="fw-bold">${guitarra.precio}</td>
                                                                    <td className="flex align-items-start gap-4">
                                                                        <button 
                                                                        onClick={() => quitaUno(guitarra)}
                                                                    ...
                                                                    <td>
                                                                        <button 
                                                                        onClick={() => quitaGuitarra(guitarra.id)}
            ...
            <div className="row mt-5">
                <div className="col-md-6 text-center text-md-start pt-5">
                    <h1 className="display-2 fw-bold">{guitar.nombre}</h1>
